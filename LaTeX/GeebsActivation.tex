...
\section{Introduction}
    ...
    The second of our criteria derived functions is the Maxim-ReLU function. This meets all of the strict criteria but does not meet the relaxed bound function criteria . This is characteristic of a ReLU function though, so is acceptable.
    \begin{equation}
    ...
    \end{equation}
    Where ${0} < \alpha \leq {1}$ and ${0} < \beta$.
