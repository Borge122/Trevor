...
\section{Introduction}
    ...
    The second of our criteria derived functions is the Maxim-ReLU function. This meets all of the strict criteria but does not meet the bound function criteria out of the relaxed criteria. This is characteristic of a ReLU function though so is acceptable.
